<template>
  ...
  >
    <i
      class="bi transition-all duration-500 group-hover:scale-110 group-hover:rotate-[360deg] text-base"
      :class="isDarkMode ? 'bi-sun-fill text-amber-400' : 'bi-moon-stars-fill text-indigo-600'"
    ></i>
  </button>
</template>
